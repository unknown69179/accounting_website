...
export function Reports(){
    ...
    const [refreasher,set_refreasher] = useState(false)
    ...
    return(
        <div className="main_body">
            <div className="board" style={{...doc_style,width:"600px",height:"400px",}}>
                <p>Reports</p>
                    <Date_Search setter={setReports} loader={setLoading} refresher={refreasher}/>
                <table>
                    <thead>
                    ...
                    <tbody>
                        ...
                        reports.map((raw,idx) =>(
                            <tr key={raw.id} style={{borderBottom: nightMode ?"1px solid white":" 2px solid hsl(0, 0%, 0%)"}} className={nightMode? "night":"day"} onClick={() => {
                                setShowInfo(true);
